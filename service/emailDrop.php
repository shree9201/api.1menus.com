...
class emailDrop {
	...
	function __construct() {
		...
		$this->urlBase = "https://spurbz.com/app/service/emailDrop/server/email.php";
		$this->urlBase = "http://droptech.in/emailDrop/server/email.php";
		//$this->urlBase = "https://spurbz.com/app/service/emailDrop/server/email.php";
		$this->urlBase = "https://crestwio.com/app/service/emailDrop/server/email.php";
