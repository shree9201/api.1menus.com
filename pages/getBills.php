...
?>
        <tbody>
            ...
            <tr><td>date</td><td>(Optional) Bill Specific Date (YYYY-MM-DD) format only</td></tr>
            <tr><td>lastUpdated</td><td>(Optional) get Bill Specific perid after the timestamp(created_date) format only</td></tr>
